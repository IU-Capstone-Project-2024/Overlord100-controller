...
class DiffDriveController : public rclcpp::Node {
   ...
   private:
    void cmdVelCallback(const geometry_msgs::msg::Twist::SharedPtr msg) {
        ...
        // double linear_velocity = lin_vx;
        // // = std::sqrt(lin_vx * lin_vx + lin_vy * lin_vy);
...
//         // Publisher for the wheel velocities
//         wheels_pub_ =
//         this->create_publisher<overlord100_msgs::msg::WheelsData>(
//             "wheels_control", 10);
...
//    private:
//     void create_wall_timer(const geometry_msgs::msg::Twist::SharedPtr msg) {
//         double angular_right_rpm = 100 * 30 / M_PI;
//         double angular_left_rpm = 100 * 30 / M_PI;
...
//     cmd_vel_sub_;
//     rclcpp::Publisher<overlord100_msgs::msg::WheelsData>::SharedPtr
//     wheels_pub_; rclcpp::TimerBase::SharedPtr timer_; double wheel_radius_;
//     double robot_base_;
//     double half_robot_base_;
// };
